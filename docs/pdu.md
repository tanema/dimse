...
| 7-8       | Protocol-version                | uint16 Tone bit to identify each version |
| 9-10      | Reserved                        | `0000H`                             |
...
| 43-74     | Reserved                        | 00H                                 |
| 75-xxx    | Variable items                  | Application Context Item, one or more Presentation Context Items and one User Information Item. |
...
| 2         | Reserved                        | `00H`                               |
| 3-6       | PDU-length                      | uint16 number of bytes from the first byte of the following field to the last byte of the variable field.
| 7-8       | Protocol-version                | This is Version 1 and shall be identified with bit 0 set
| 9-10      | Reserved                        | `0000H`                             |
...
| 75-xxx    | Variable items                  | Application Context Item, one or more Presentation Context Item(s) and one User Information Item.
